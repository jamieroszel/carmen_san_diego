...
-- We're following our gut on this one; find out what other city in that 
...
-- similar names, but in totally different parts of the globe! 
-- She's headed to South America as we speak; go find a city whose name is 
-- like the one we were headed to, but doesn't end the same. 
-- Find out the city, and do another search for what country it's in. Hurry!
SELECT * FROM city WHERE name LIKE 'Serra%'; -- Serra
...
--and is headed towards the capital! Look up the country's capital, 
-- and get there pronto! Send us the name of where you're headed and we'll 
-- follow right behind you!
SELECT * FROM city WHERE id = '211'; -- Brasï¿½lia
...
SELECT * FROM city WHERE population = '91084'; -- Santa Monica
